    ...
    if (typeof e === "undefined") {
        ...
        (function () {
            ...
            if (window.performance && window.performance.timing.domContentLoadedEventStart) {
                h = (window.performance.timing.domContentLoadedEventStart - window.performance.timing.navigationStart) / 1000
            }
...
function WAU_r_u(c, key, async_index) {
    var col;
    ...
    img.onload = function () {
        ...
        wid.onclick = function () {
            top.location = "//whos.amung.us/stats/" + key + "/"
        };
        if (async_index >= 0) {
