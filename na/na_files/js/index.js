 ...
 * ver 0.1.6 增加账户/同步操作	-- 17.08.20
 * ver 0.1.7 拖拽修改	-- 17.08.23
 * ver 0.1.8 壁纸/Logo		-- 17.08.24/6
 */
var favObj = {
    temp: {
        "mangerStatus": false,
    ...
    userManger: function (_type) {
        ...
        if (type == 'do_login') {
            ...
            param = {
                "header_logo_day": $('#header_logo_day').val(),
                "header_logo_night": $('#header_logo_night').val(),
                "day_pc": $('#day_pc').val(),
                "night_pc": $('#night_pc').val(),
                "night_mobile": $('#night_mobile').val(),
                "day_mobile": $('#day_mobile').val()
            };
    ...
    dataMgr: function (_name, data, _sync_flag) { // _data = null
        ...
        if (typeof data == 'undefined') {
            ...
            if (sync_flag && user_data != null) {
                $.post('index.php?m=Damalu&c=Index&a=doSync', {
                    "data": encodeURIComponent(itemStr),
