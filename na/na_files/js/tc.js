//v146 Copyright (c) 2008-2018 33Across Inc. All Rights Reserved
...
"undefined" == typeof Tynt.TIL && "undefined" == typeof Tynt.TCL && "undefined" == typeof Tynt.TICFL && function () {
    ...
    Tynt.TCL = function () {
        function J(a) {
            ...
            c[b.q.name] = {};
            c[b.key[12]].replace(b.q.parser, function (a, e, d) {
                e && (c[b.q.name][e] = d)
            });
            return c
        }
        if (document.body) {
            ...
            var f = {
                    ...
                    init: function () {
                        this._icUrl = n.protocol + (Tynt.e || "") + "ic.tynt.com";
                    ...
                    injectPixel: function (a, b, c) {
                        ...
                        e && (this._imgs.push(e), b && (e.onload = b), c && (e.onerror = c), e.src = a)
                    },
                    docUrl: function () {
                    ...
                    getMeta: function (a, b, c, e) {
                        var d, k = null,
                            h = null,
                            m = g.getElementsByTagName("meta");
                        for (d = 0; d < m.length; ++d) k || m[d].getAttribute(a) !== b ? c && !h && m[d].getAttribute(c) === e && (h = m[d].getAttribute("content") || null) : k = m[d].getAttribute("content") || null;
                        return k || h
                    },
                    ...
                    iframeType: function () {
                        ...
                        if (a) a.id && 0 <= a.id.search(/google_ads?_i?frame/) ? (b = 6, f.clog("In same-origin iframe from DFP" + c)) : (b = L, f.clog("In same-origin iframe" + c));
                            ...
                            b = z, f.clog("iframeType: " + e.message)
                        }
                        return b
                    },
                    ...
                    countIds: function (a) {
                        var b, c = 0;
                        for (b = 0; b < Tynt.length; ++b) Tynt[b] === a && ++c;
                        return c
                    },
                    _log: function (a) {
                    ...
                    log: function () {
                        n.inXOIframe() ? this.clog.apply(this, arguments) : this._log(this.toArray(arguments))
                    },
                    clog: function () {
                    ...
                    callIc: function () {
                        ...
                        if (!d._33Across.state.icDone) {
                            ...
                            f.callIc.rsp = function () {
                                d._33Across.state.icDone = G
                            };
                            f.clog("Calling IC");
                            this.injectPixel(b, f.callIc.rsp, function () {
                                f.injectPixel(m, f.callIc.rsp, function () {
                                    f.injectPixel(h, f.callIc.rsp, function () {
                                        f.injectPixel(k, f.callIc.rsp, function () {
                                            f.injectPixel(y, f.callIc.rsp, function () {
                                                f.injectPixel(e, f.callIc.rsp, function () {
                                                    f.injectPixel(c, f.callIc.rsp)
                                                })
                                            })
                                        })
                                    })
                    ...
                    callDeb: function (a) {
                        function b(a, b) {
                            ...
                            var y = encodeURIComponent(f.trunc(g.referrer, f._maxRef));
                            f.injectScript(f._debUrl + "?id=" + f.tyntIds() + "&dn=" + n.distro + "&cc=" + b + "&r=" + y, d)
                        }
                        "undefined" == typeof a && (a = 1);
                        d._33Across.state.deDone >= a || (++d._33Across.state.deDone, this.when(function () {
                            return d._33Across.state.icDone == G
                        }, b, {
                            timeout: 300,
                            timeoutCallback: b,
                            callbackData: d._33Across.state.deDone
                        }, this))
                    },
                    callDebX: function (a, b) {
                        ...
                        a || (a = 10);
                        d._33Across.state.dxDone >= a || (++d._33Across.state.dxDone, this.when(function () {
                            return d._33Across.state.icDone == G
                        }, c, {
                            timeout: 300,
                            timeoutCallback: c,
                            callbackData: d._33Across.state.dxDone
                        }, this))
                    },
                    ...
                    when: function (a, b, c, e) {
                        ...
                        m = d.setInterval(function () {
                            if (p = a()) d.clearInterval(m), d.clearTimeout(g), b.call(e, p, c.callbackData)
                        }, f);
                        k && (g = d.setTimeout(function () {
                            d.clearInterval(m);
                            h.call(e, p, c.callbackData)
                        }, k));
                        return !1
                    },
                    prob: function (a) {
            ...
            n.inXOIframe = function () {
                return this.type >= z && this.type <= M
            };
            n.init = function () {
                ...
                "https:" === d.location.protocol ? (this.isSecure = !0, this.protocol = "https://") : (this.isSecure = !1, this.protocol = "http://");
                f.init();
            ...
            var l = g.body,
                ...
                O = C + "/b/s",
                P;
            P = d.addEventListener ? function (a, b, c) {
                a.addEventListener(b, c, !1)
            } : function (a, b, c) {
                a.attachEvent("on" + b, c)
            };
            var Y = function (a) {
                    "complete" == g.readyState ? a() : P(d, "load", function (b) {
                        setTimeout(function () {
                            "undefined" != typeof g.readyState || X || (g.readyState = "complete");
                            a()
                        }, 10)
                    })
                },
                v = function (a, b) {
                    ...
                    Y(function () {
                        v = e;
                        for (var a = 0; a < c.length; a++) v(c[a][0], c[a][1]);
                        c = null
                    });
                    v(a, b)
                },
                ...
                T = function (a) {
                    ...
                    a -= 62 * b;
                    return 62 <= b ? T(b) + "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".charAt(a) : "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".charAt(b) + "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".charAt(a)
                },
                R = function (a, b) {
                    var c = T(a);
                    return N("0", b - c.length) + c
                },
                ...
                I = function (a) {
                    var b = function (a) {
                            return "number" == typeof a.pageX ? {
                                x: a.pageX - (q.scrollLeft ? q.scrollLeft : l.scrollLeft),
                                y: a.pageY - (q.scrollTop ? q.scrollTop : l.scrollTop)
                            } : {
                                x: a.clientX,
                                y: a.clientY
                            }
                        ...
                        h = function (a) {
                            h = navigator.userAgent.match("MSIE") ? g.compatMode && -1 != g.compatMode.indexOf("CSS") ? e : c : navigator.userAgent.match("Firefox") ? d : f;
                            h(a)
                        };
                    return function (a) {
                        u && h(a) && (H(u), u = null);
            ...
            Tynt.ci = function () {
                ...
                return function (b, c) {
                    a = c || a;
                    var e = O + ["?ci=", b, "&id=", D, "&g=", a, "&r=", encodeURIComponent(g.referrer), "&ts=", Date.now()].join("");
                    v(e)
                }
            }();
            Tynt.st = function () {
...
encodeURIComponent(b), "=", encodeURIComponent(c), "&id=", D, "&g=", a, "&r=", encodeURIComponent(g.referrer), "&href=", encodeURIComponent(d.location.href), "&ts=", Date.now()];
                    ...
                    if (f) {
                        c = [];
                        e = "";
                        for (var k in f) f.hasOwnProperty(k) && (c.push(e, encodeURIComponent(k), "=", encodeURIComponent(f[k])), e = "&");
                        c = "&" + c.join("")
                    }
                    v(b.join("") + c)
                }
            ...
            Tynt.c ? t = function () {} : (Tynt.c = !0, Tynt.m = Tynt.m || [], Tynt.n = Tynt.n || [], t = function () {
                var a = !0,
                    b, c = function (b, c) {
                        ...
                        var g = h.g;
                        delete h.g;
                        for (var B = [], p = "id wc f w h t c".split(" "), A = 0; A < p.length; A++) {
                            var q = p[A],
                                l = h[q];
                        ...
                        for (r[F] = {
                                g: g,
                                tp: null
                            }; l < q && 35 > r.length;) t = B[l][0], h = B[l][1],
                            z = t.length + 2, u = A - z - w, 0 < u ? (p = h.substring(x, x + u), E = p.slice(-2).indexOf("%"), -1 < E && (p = h.substring(x, x + u - 2 + E), w += E + 2), w += p.length + z, x += p.length, r[F][t] = p) : w = A, w >= A && (r[++F] = {
                                g: g,
                                p: F
                            }, w = 0), x >= h.length && (l++, x = 0);
                        r[0].tp = r.length;
                        v(C + "/b/t/" + d + "?" + Q(r[0]));
                ...
                return function (a, n) {
                    if (!g.getElementById("tyntSh")) {
                        ...
                        if (l && !k && ca(l)) {
                            ...
                            c(h, l)
                        } else if (k && f.trim(k).length && "TEXTAREA" != a.nodeName && "INPUT" != a.nodeName) {
                            l = ba(k);
                            h = {
                                trace_type: 1
                            };
                            l && (b = S(k));
                            h.g = b;
                            for (var p = !0, q = 0; q < Tynt.m.length; q++) p = p && Tynt.m[q](h, k, m, l);
                            l && p && c(h, k)
                        }
                    }
                }
